...
public abstract class Shader {
    ...
    public Shader(String fragmentShader) {
        ...
        int vertexShaderID;
        try {
            InputStream vertexStream = this.getClass().getResourceAsStream("/assets/kami/shader/vertex.vert");
            ...
            InputStream fragmentStream = this.getClass().getResourceAsStream("/assets/kami/shader/shaders/" + fragmentShader);
