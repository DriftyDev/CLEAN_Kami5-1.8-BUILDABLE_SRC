...
extends Module {
    ...
    Value<Number> minDamage = new ValueBuilder().withDescriptor("Min Damage").withValue(4.0).withRange(0.0, 20.0).withPageParent(this.page).withPage("Calc").register(this);
    Value<Number> maxSelfDamage = new ValueBuilder().withDescriptor("Max Self Damage").withValue(15.0).withRange(0.0, 36d).withPageParent(this.page).withPage("Calc").register(this);
    Value<Boolean> antiSuicide = new ValueBuilder().withDescriptor("Anti Suicide").withValue(false).withPageParent(this.page).withPage("Calc").register(this);
    Value<Number> antiSuicideHealth = new ValueBuilder().withDescriptor("Anti Suicide Health").withValue(36).withRange(0, 36).withPageParent(this.page).withPage("Calc").register(this);
    Value<Number> antiSuicideFactor = new ValueBuilder().withDescriptor("Anti Suicide Factor").withValue(4).withRange(0, 10).withPageParent(this.page).withPage("Calc").register(this);
    Value<Number> lethalHealth = new ValueBuilder().withDescriptor("Lethal Health").withValue(18).withRange(0, 36).withPageParent(this.page).withPage("Calc").register(this);
    Value<Number> lethalMinDmg = new ValueBuilder().withDescriptor("Lethal Min Damage").withValue(2).withRange(0, 36).withPageParent(this.page).withPage("Calc").register(this);
    Value<Number> lethalMaxSelfDmg = new ValueBuilder().withDescriptor("Lethal Max Self DMG").withValue(36).withRange(0, 36).withPageParent(this.page).withPage("Calc").register(this);
    Value<Number> targetRange = new ValueBuilder().withDescriptor("Target Range").withValue(7.0).withPageParent(this.page).withPage("Calc").withRange(3.0, 20.0).register(this);
    Value<Number> range = new ValueBuilder().withDescriptor("Range").withValue(5).withRange(1, 10).withPageParent(this.page).withPage("Calc").register(this);
    Value<Number> wallsRange = new ValueBuilder().withDescriptor("Walls Range").withValue(3).withRange(1, 5).withPageParent(this.page).withPage("Calc").register(this);
    Value<Number> raytraceHits = new ValueBuilder().withDescriptor("Raytrace Hits").withValue(2).withRange(1, 9).withPageParent(this.page).withPage("Calc").register(this);
    Value<Number> shrinkFactor = new ValueBuilder().withDescriptor("Shrink Factor").withValue(0.3).withRange(0d, 1d).withPageParent(this.page).withPage("Calc").register(this);
    Value<Number> breakDelay = new ValueBuilder().withDescriptor("Break Delay").withValue(1).withRange(0, 1000).withPageParent(this.page).withPage("Delays").register(this);
    Value<Number> placeDelay = new ValueBuilder().withDescriptor("Place Delay").withValue(1).withRange(0, 1000).withPageParent(this.page).withPage("Delays").register(this);
    Value<Boolean> antiSurround = new ValueBuilder().withDescriptor("Anti Surround").withValue(false).withPageParent(this.page).withPage("Delays").register(this);
    Value<Number> antiSurroundDelay = new ValueBuilder().withDescriptor("Anti Surround Delay").withValue(1).withRange(0, 1000).withPageParent(this.page).withPage("Delays").register(this);
    Value<Boolean> antiStuck = new ValueBuilder().withDescriptor("Anti Stuck").withValue(false).withPageParent(this.page).withPage("Delays").register(this);
    Value<Boolean> placeCrystals = new ValueBuilder().withDescriptor("Place").withValue(true).withPageParent(this.page).withPage("Place").register(this);
    Value<Boolean> antiChorus = new ValueBuilder().withDescriptor("Anti Chorus").withValue(false).withPageParent(this.page).withPage("Place").register(this);
    ...
    Value<Boolean> one13 = new ValueBuilder().withDescriptor("1.13").withValue(false).withPageParent(this.page).withPage("Place").register(this);
    Value<Boolean> packetPlace = new ValueBuilder().withDescriptor("Packet Place").withValue(true).withPageParent(this.page).withPage("Place").register(this);
    Value<String> switchMode = new ValueBuilder().withDescriptor("Switch Mode").withValue("None").withPageParent(this.page).withPage("Place").withModes("None", "Normal", "Silent").register(this);
    Value<Boolean> breakCrystals = new ValueBuilder().withDescriptor("Break").withValue(true).withPageParent(this.page).withPage("Break").register(this);
    Value<Boolean> breakRotate = new ValueBuilder().withDescriptor("Break Rotate").withValue(true).withPageParent(this.page).withPage("Break").register(this);
    Value<Number> breakAttempts = new ValueBuilder().withDescriptor("Break Attempts").withValue(1).withRange(1, 10).withPageParent(this.page).withPage("Break").register(this);
    Value<Boolean> setDead = new ValueBuilder().withDescriptor("Set Dead").withValue(true).withPageParent(this.page).withPage("Break").register(this);
    ...
    Value<Boolean> onlyOwn = new ValueBuilder().withDescriptor("Only Own").withValue(true).withPageParent(this.page).withPage("Break").register(this);
    Value<Boolean> sequential = new ValueBuilder().withDescriptor("Sequential").withValue(true).withPageParent(this.page).withPage("Break").register(this);
    Value<Boolean> packetBreak = new ValueBuilder().withDescriptor("Packet Break").withValue(true).withPageParent(this.page).withPage("Break").register(this);
    Value<Boolean> predict = new ValueBuilder().withDescriptor("Predict").withValue(false).withPageParent(this.page).withPage("Break").register(this);
    Value<Boolean> smartPredict = new ValueBuilder().withDescriptor("Smart Predict").withValue(true).withPageParent(this.page).withPage("Break").register(this);
    Value<Number> breakPredictAttempts = new ValueBuilder().withDescriptor("Predict Attempts").withValue(3).withRange(1, 10).withPageParent(this.page).withPage("Break").register(this);
    Value<Boolean> autoSkip = new ValueBuilder().withDescriptor("Auto Skip").withValue(true).withPageParent(this.page).withPage("Break").register(this);
    Value<Number> skip = new ValueBuilder().withDescriptor("Predict Skip").withValue(2).withRange(1, 10).withPageParent(this.page).withPage("Break").register(this);
    Value<Number> startFactor = new ValueBuilder().withDescriptor("Predict Start").withValue(2).withRange(0, 10).withPageParent(this.page).withPage("Break").register(this);
    Value<Number> add = new ValueBuilder().withDescriptor("Predict Add").withValue(2).withRange(0, 10).withPageParent(this.page).withPage("Break").register(this);
    Value<Boolean> instaminePoll = new ValueBuilder().withDescriptor("Instamine Poll").withValue(false).withPageParent(this.page).withPage("Dev").register(this);
    Value<Color> fillColorS = new ValueBuilder().withDescriptor("Fill Color").withValue(new Color(0, 0, 0, 100)).withPageParent(this.page).withPage("Render").register(this);
    Value<Color> lineColorS = new ValueBuilder().withDescriptor("Outline Color").withValue(new Color(255, 255, 255, 255)).withPageParent(this.page).withPage("Render").register(this);
