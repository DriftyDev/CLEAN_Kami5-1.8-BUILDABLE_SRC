...
extends Module {
    ...
    Value<Entity> playerVisualizer = new ValueBuilder().withDescriptor("Crystal Visualizer").withValue(null).withComponent(new VisualizerWidget(null)).register(this);
    Value<Boolean> playerCancel = new ValueBuilder().withDescriptor("Cancel", "playerCancel").withValue(false).register(this);
    Value<Boolean> Self = new ValueBuilder().withDescriptor("Self", "playerSelf").withValue(false).register(this);
    Value<Boolean> playerTexture = new ValueBuilder().withDescriptor("Texture", "playerTexture").withValue(false).register(this);
    Value<Boolean> playerSecondaryTexture = new ValueBuilder().withDescriptor("Secondary Texture", "playerSecondaryTexture").withValue(false).register(this);
    Value<Color> playerSecondaryTextureColor = new ValueBuilder().withDescriptor("Secondary Texture Color", "playerSecondaryTextureColor").withValue(new Color(255, 255, 255)).register(this);
    Value<Color> playerFill = new ValueBuilder().withDescriptor("Fill", "playerFill").withValue(new Color(255, 255, 255, 255)).register(this);
    Value<Color> playerLine = new ValueBuilder().withDescriptor("Line", "playerLine").withValue(new Color(255, 255, 255, 255)).register(this);
    Value<Color> friendFill = new ValueBuilder().withDescriptor("Friend Fill", "friendFill").withValue(new Color(255, 255, 255, 255)).register(this);
    Value<Color> friendLine = new ValueBuilder().withDescriptor("Friend Line", "friendLine").withValue(new Color(255, 255, 255, 255)).register(this);
    Value<Boolean> playerGlint = new ValueBuilder().withDescriptor("Glint", "playerGlint").withValue(true).register(this);
    Value<Boolean> playerImage = new ValueBuilder().withDescriptor("Player Image").withValue(false).register(this);
    Value<Color> playerGlintColor = new ValueBuilder().withDescriptor("Glint Color", "playerGlintColor").withValue(new Color(255, 255, 255, 255)).register(this);
    ...
    public Value<Boolean> noArmor = new ValueBuilder().withDescriptor("No Armor").withValue(false).register(this);
    Value<Boolean> crystals = new ValueBuilder().withDescriptor("Crystals").withValue(true).register(this);
    Value<Entity> crystalVisualizer = new ValueBuilder().withDescriptor("Crystal Visualizer").withValue(null).withComponent(new VisualizerWidget((Entity)new EntityEnderCrystal(null))).register(this);
    Value<Boolean> crystalCancel = new ValueBuilder().withDescriptor("Cancel", "crystalCancel").withValue(false).register(this);
    Value<Boolean> crystalTexture = new ValueBuilder().withDescriptor("Texture", "crystalTexture").withValue(false).register(this);
    Value<Boolean> crystalSecondaryTexture = new ValueBuilder().withDescriptor("Secondary Texture", "crystalSecondaryTexture").withValue(false).register(this);
    Value<Color> crystalSecondaryTextureColor = new ValueBuilder().withDescriptor("Secondary Texture Color", "crystalSecondaryTextureColor").withValue(new Color(255, 255, 255)).register(this);
    ...
    Value<Boolean> crystalGlint = new ValueBuilder().withDescriptor("Glint", "crystalGlint").withValue(true).register(this);
    Value<Color> crystalFill1 = new ValueBuilder().withDescriptor("Fill 1", "crystalFill1").withValue(new Color(255, 255, 255, 255)).register(this);
    Value<Color> crystalLine1 = new ValueBuilder().withDescriptor("Line 1", "crystalLine1").withValue(new Color(255, 255, 255, 255)).register(this);
    Value<Color> crystalGlint1 = new ValueBuilder().withDescriptor("Glint 1", "crystalGlint1").withValue(new Color(255, 255, 255, 255)).register(this);
    Value<Color> crystalFill2 = new ValueBuilder().withDescriptor("Fill 2", "crystalFill2").withValue(new Color(255, 255, 255, 255)).register(this);
    Value<Color> crystalLine2 = new ValueBuilder().withDescriptor("Line 2", "crystalLine2").withValue(new Color(255, 255, 255, 255)).register(this);
    Value<Color> crystalGlint2 = new ValueBuilder().withDescriptor("Glint 2", "crystalGlint2").withValue(new Color(255, 255, 255, 255)).register(this);
    Value<Color> crystalFill3 = new ValueBuilder().withDescriptor("Fill 3", "crystalFill3").withValue(new Color(255, 255, 255, 255)).register(this);
    Value<Color> crystalLine3 = new ValueBuilder().withDescriptor("Line 3", "crystalLine3").withValue(new Color(255, 255, 255, 255)).register(this);
    Value<Color> crystalGlint3 = new ValueBuilder().withDescriptor("Glint 3", "crystalGlint3").withValue(new Color(255, 255, 255, 255)).register(this);
    Value<Boolean> crystalShader = new ValueBuilder().withDescriptor("Crystal Shader").withValue(false).register(this);
    Value<Number> lineWidth = new ValueBuilder().withDescriptor("Line Width").withValue(Float.valueOf(2.0f)).withRange(0.1f, 5f).register(this);
    Value<Number> lineWidthInterp = new ValueBuilder().withDescriptor("Line Width Interp").withValue(Float.valueOf(5.0f)).withRange(0.1f, 15f).register(this);
    ...
    void handlePage(String page) {
        this.players.setActive(page.equals("Players"));
        this.playerVisualizer.setActive(page.equals("Players"));
        this.playerCancel.setActive(page.equals("Players"));
        this.playerTexture.setActive(page.equals("Players"));
        this.playerSecondaryTexture.setActive(page.equals("Players"));
        this.playerSecondaryTextureColor.setActive(page.equals("Players"));
        this.playerFill.setActive(page.equals("Players"));
        this.playerLine.setActive(page.equals("Players"));
        this.friendFill.setActive(page.equals("Players"));
        this.friendLine.setActive(page.equals("Players"));
        this.playerGlint.setActive(page.equals("Players"));
        this.playerGlintColor.setActive(page.equals("Players"));
        this.friendGlintColor.setActive(page.equals("Players"));
        this.noArmor.setActive(page.equals("Players"));
        this.playerImage.setActive(page.equals("Players"));
        this.crystals.setActive(page.equals("Crystals"));
        this.crystalVisualizer.setActive(page.equals("Crystals"));
        this.crystalCancel.setActive(page.equals("Crystals"));
        this.crystalTexture.setActive(page.equals("Crystals"));
        this.crystalSecondaryTexture.setActive(page.equals("Crystals"));
        this.crystalSecondaryTextureColor.setActive(page.equals("Crystals"));
        this.crystalRotateSpeed.setActive(page.equals("Crystals"));
        this.crystalScale.setActive(page.equals("Crystals"));
        this.crystalGlint.setActive(page.equals("Crystals"));
        this.crystalFill1.setActive(page.equals("Crystals"));
        this.crystalLine1.setActive(page.equals("Crystals"));
        this.crystalGlint1.setActive(page.equals("Crystals"));
        this.crystalFill2.setActive(page.equals("Crystals"));
        this.crystalLine2.setActive(page.equals("Crystals"));
        this.crystalGlint2.setActive(page.equals("Crystals"));
        this.crystalFill3.setActive(page.equals("Crystals"));
        this.crystalLine3.setActive(page.equals("Crystals"));
        this.crystalGlint3.setActive(page.equals("Crystals"));
        this.crystalShader.setActive(page.equals("Crystals"));
    }
